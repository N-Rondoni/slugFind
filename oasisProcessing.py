...
if __name__=="__main__":
       ...
       #dsets = [1, 2, 3, 4, 5]
        ...
        for dset in dsets:
            ...
            while i < mSpike:
                ...
                print("Afer removal Oasis shape", np.shape(simSpikesRawOasis))
    ...
    #downsampledCorScor = downsampledCorScor[~np.isnan(downsampledCorScor)] removes all NaN values
    downsampledCorScor[np.isnan(downsampledCorScor)] = 0 
